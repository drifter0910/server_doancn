...
<div class="container" style="align-items: center">
    <form action="/api/addproduct" method="POST" enctype="multipart/form-data">
        ...
        <div class=" row mb-3">
            <label class="col-4 text-center d-flex justify-content-center align-items-center" for="lname">Discount</label>
            <input class="col-6 bg-white" type="text" id="discount" name="discount" placeholder="Discount" />

        </div>
        <div class=" row mb-3">
            <label class="col-4 text-center d-flex justify-content-center align-items-center " for="subject">Category</label>
            <input class="col-6 bg-white" type="text" id="category" name="category" placeholder="Category" />
        ...
        <div class="text-center ">
            <input class="col-2" type="submit" name="Upload" value="Edit" />
        </div>
    </form>
</div>
@endsection
