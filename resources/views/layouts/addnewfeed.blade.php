...
<div class="container" style="align-items: center">
    <form action="/api/addnewfeed" method="POST" enctype="multipart/form-data">
        @csrf
        <h1 class="text-center mt-4 mb-4">ADD NEWFEEDS</h1>
        <div class=" row mb-3 ">

            <label class="col-4 text-center d-flex justify-content-center align-items-center" for="name">Name</label>
        ...
        <div class="text-center ">
            <input class="col-2" type="submit" name="Upload" value="Add newfeed" />
        </div>
    </form>
</div>
@endsection
